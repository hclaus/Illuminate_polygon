...
export const ContourOverlaySchema = z.object({
  ...
  relX: z.number().optional().default(0.0),
  relY: z.number().optional().default(0.0),
  relW: z.number().optional().default(1.0),
  relH: z.number().optional().default(1.0),
  rot: z.number().optional().default(0.0),
  opacity: z.number().optional().default(1.0),
  computer_path: z.string().nullable().optional(),
}).passthrough();

export const ContourSettingsSchema = z.object({
  levels: z.string().optional().default("0.2, 0.4, 1.0, 2.0"),
  labels: z.string().optional().default("0.2, 0.4, 1.0, 2.0"),
  colors: z.string().optional().default("#0000ff, #00ff00, #ffff00, #ff0000"),
  floorColor: z.string().optional().default("#808080"),
  sigma: z.number().optional().default(1.0),
  filled: z.boolean().optional().default(true),
  ...
  useRawDataLimits: z.boolean().optional().default(false),
